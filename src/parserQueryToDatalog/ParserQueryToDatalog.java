/* Generated By:JavaCC: Do not edit this line. ParserQueryToDatalog.java */
...
public class ParserQueryToDatalog implements ParserQueryToDatalogConstants {
...
final public String move() throws ParseException, InputMismatchException, IOException, parserRuletoJava.ParseException, EntityNotFoundException {
  ...
  public ParserQueryToDatalogTokenManager token_source;
  ...
  public ParserQueryToDatalog(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public ParserQueryToDatalog(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new ParserQueryToDatalogTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public ParserQueryToDatalog(java.io.Reader stream) {
  ...
  public ParserQueryToDatalog(ParserQueryToDatalogTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(ParserQueryToDatalogTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
